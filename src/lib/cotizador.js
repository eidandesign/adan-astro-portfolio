...
export const LABELS = {
  es: {
    ...
    generar: "Generar propuesta",
    generando: "Generando…",
    guardarCambios: "Guardar cambios",
    cambiosGuardados: "Cambios guardados ✓",
    regenerar: "Regenerar propuesta",
    ...
    compartir: "Compartir link",
    linkCopiado: "Link copiado — listo para enviar",
    menuAcciones: "Menú de acciones",
    ...
    eliminarAprobacion: "Eliminar aprobación",
    ...
    aprobarCorto: "Aprobar",
    rechazarCorto: "Rechazar",
    rechazada: "Rechazada",
    rechazadaToast: "Cotización marcada como rechazada",
    rechazadaComentario: "🚫 Cotización rechazada",
    quitarRechazo: "Quitar rechazo",
    rechazoQuitado: "Rechazo quitado — vuelve a 'sin estado'",
    // Filtros del drawer
    filtroTodas: "Todas",
    filtroAprobadas: "Aprobadas",
    filtroRechazadas: "Rechazadas",
    // Comments
    ...
    duplicar: "Duplicar",
    eliminar: "Eliminar",
    eliminarTitulo: "¿Eliminar esta cotización?",
    eliminarTexto: "Se borrará de este navegador y, si se guardó en el backend, también de ahí. Esta acción no se puede deshacer.",
    cancelar: "Cancelar",
  ...
  en: {
    ...
    sTimeline: "Timeline",
    generar: "Generate proposal",
    generando: "Generating…",
    guardarCambios: "Save changes",
    cambiosGuardados: "Changes saved ✓",
    regenerar: "Regenerate proposal",
    ...
    compartir: "Share link",
    linkCopiado: "Link copied — ready to send",
    menuAcciones: "Actions menu",
    aprobar: "Approve quote",
    aprobada: "Approved",
    aprobadaToast: "Quote approved! 🎉",
    aprobadaComentario: "✅ Quote approved",
    quitarAprobacion: "Remove approval",
    eliminarAprobacion: "Remove approval",
    aprobacionQuitada: "Approval removed — back to 'not approved'",
    errAprobacion: "Couldn't update the approval. Try again.",
    rechazar: "Mark as declined",
    aprobarCorto: "Approve",
    rechazarCorto: "Decline",
    rechazada: "Declined",
    rechazadaToast: "Quote marked as declined",
    rechazadaComentario: "🚫 Quote declined",
    quitarRechazo: "Remove rejection",
    rechazoQuitado: "Rejection removed — back to 'no status'",
    filtroTodas: "All",
    filtroAprobadas: "Approved",
    filtroRechazadas: "Declined",
    ...
    duplicar: "Duplicate",
    eliminar: "Delete",
    eliminarTitulo: "Delete this quote?",
    eliminarTexto: "It will be removed from this browser and, if saved to the backend, from there too. This can't be undone.",
    cancelar: "Cancel",
